...
export const DEFAULT_SHORTCUTS: ShortcutDefinition[] = [
  ...
  { id: 'clear-search', label: 'Clear / Close', description: 'Clear search or close QuikFind', keys: 'Esc', defaultKeys: 'Esc', category: 'Navigation' },
  { id: 'navigate-up', label: 'Navigate Up', description: 'Move selection upward', keys: 'ArrowUp', defaultKeys: 'ArrowUp', category: 'Navigation' },
  { id: 'navigate-down', label: 'Navigate Down', description: 'Move selection downward', keys: 'ArrowDown', defaultKeys: 'ArrowDown', category: 'Navigation' },
